...
from totoro.ldm.util import get_obj_from_str, instantiate_from_config
...
class AutoencodingEngineLegacy(AutoencodingEngine):
    def __init__(self, embed_dim: int, **kwargs):
        ...
        if ddconfig.get("conv3d", False):
            conv_op = totoro.ops.disable_weight_init.Conv3d
        else:
            conv_op = totoro.ops.disable_weight_init.Conv2d
