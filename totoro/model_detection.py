...
def model_config_from_unet(state_dict, unet_key_prefix, use_base_if_no_match=False):
    ...
    if model_config is None and use_base_if_no_match:
        model_config = totoro.supported_models_base.BASE(unet_config)
...
def convert_diffusers_mmdit(state_dict, output_prefix=""):
    ...
    if 'joint_transformer_blocks.0.attn.add_k_proj.weight' in state_dict: #AuraFlow
        ...
        sd_map = totoro.utils.flux_to_diffusers({"depth": depth, "depth_single_blocks": depth_single_blocks, "hidden_size": hidden_size}, output_prefix=output_prefix)
